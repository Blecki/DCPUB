...
namespace DCPUB
{
    public partial class CompilableNode : AstNode
    {
        ...
        public virtual void ResolveTypes(CompileContext context, Model.Scope enclosingScope)
        {
        ...
        public virtual void GatherSymbols(CompileContext context, Model.Scope enclosingScope) 
        {
            foreach (CompilableNode child in ChildNodes)
